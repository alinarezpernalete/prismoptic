<?php
	...
	class PDF extends FPDF{
		function Header(){
			...
			$this->Ln(10);
			$this->Cell(0,10,utf8_decode('Reporte de Productos. Más vendido'),'C');
			$this->Ln(15);
	...
	$consulta = "SELECT p.codigo_producto, p.descripcion_producto, p.precio_producto, p.existencia_producto, COUNT(df.FK_idproducto) AS frecuencia FROM detalle_factura df, producto p WHERE df.FK_idproducto = p.idproducto GROUP BY FK_idproducto HAVING COUNT(FK_idproducto) > 0 ORDER BY frecuencia DESC LIMIT 1";
